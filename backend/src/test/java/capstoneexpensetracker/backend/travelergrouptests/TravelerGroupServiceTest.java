...
class TravelerGroupServiceTest {
    ...
    void addNewTravelerWithAnId() {
        ...
        //GIVEN
        NewTravelerGroup newTravelerGroup = new NewTravelerGroup("description", List.of(new GroupMember("1", "name", BigDecimal.ZERO, BigDecimal.ZERO)));
    ...
    void updateTravelerGroupByInvalidId() {
        ...
        //GIVEN
        TravelerGroup updatedTravelerGroup = new TravelerGroup("mallorca", List.of(new GroupMember("1", "name", BigDecimal.ZERO, BigDecimal.ZERO)), "1");
    ...
    void getTravelersByGroupId() {
        //GIVEN
        TravelerGroup travelerGroup = new TravelerGroup("des", List.of(new GroupMember("1", "name", BigDecimal.ZERO, BigDecimal.ZERO)), "1");
