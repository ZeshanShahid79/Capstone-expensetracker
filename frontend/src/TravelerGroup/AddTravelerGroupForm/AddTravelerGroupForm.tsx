...
export default function AddTravelerGroupForm({travelers, fetchAllTravelerGroups}: AddTravelerProps) {
    ...
    const handleRemoveFromList = (id: string) => {
        const filteredList = selectedTravelers.filter(traveler => traveler.id !== id)
    ...
    return (
        <section>
            ...
            <div>
                ...
                {selectedTravelers.map(traveler => <div key={traveler.id}>
                    <p>{traveler.name}</p>
            ...
            <form onSubmit={handleTravelerFrom}>
                ...
                <select name="travelers" id="travelers" onChange={handleSelectTraveler}>
                    ...
                    {travelers.map(traveler => {
                        return <option key={traveler.id} value={traveler.id}>{traveler.name}</option>
                    })
                    }
                </select>
